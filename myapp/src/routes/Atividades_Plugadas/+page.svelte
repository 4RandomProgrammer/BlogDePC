...
<!-- Introdução -->
<div class="text-white p-4 text-justify bg-violet-500/50 mb-4 rounded-2xl">
    <div class="">
    ...
    <div class="my-4">
        ...
        <p class="mb-4">Portanto, com base nos seus conhecimentos e as pesquisas realizadas, escolha a alternativa que consiste em uma atividade plugada relacionadas a pensamento computacional:</p>
        <ul class="list-[lower-latin] px-6 space-y-4">
            <li>Um jogo onde o usuário controla um robô Gari que tem que salvar o mundo da poluição. O jogo possui diversas fases, com o objetivo de coletar e reciclar os resíduos para concluir as missões.</li>
            <li>Dar cartões enumerados com para os alunos e dividi-los em grupos. O intuito é que eles se ordenem de forma crescente ou descrescente. A primeiro momento você os deixar organizar sozinhos e em um segundo momento os grupo devem exucutar um algoritmo que é dado pare eles para que se ordenem, ambos momentos devem ser cronometrados. Ao fim, deve-se comparar o tempo para entender qual foi que objeteve o melhor resultado.</li>
            <li>Um jogo de puzzle em que o jogador tem que fazer os personagens chegarem em seus bichos de estimação. O usuário possui um conjunto de comandos que indiquem em qual a direção o personagem irá seguir e o jogador pode escolher eles para serem executados de forma sequencil. Com isso, o jogador deve utilizar os comandos para construir uma forma que is persoangens evitem os obstaculos e consiga chegar no seu pat. Por fim, pós a construção da solução o personagem executa os movimentos, dando a visão ao jogo se fase foi concluida, caso isso não ocorra o jogador deve revisar os comandos para modificar a solução até que ela se encontre correta.</li>
            <li> Os alunos abrem um jogo em seu computador, podendo ser no celular ou tablet. E nele eles escolhem uma imagem da qual devem tentar montar em um quebra-cabeças, alojando as peças de forma correta dentro do espaço dedicado para isso e conectando as peças até que elas formem a imagem selecionada.</li>
            <li>Os alunos recebem um livro paradidático que aborda um tema e entram dentro do minecraft e lá dentro acessam um mundo em que é replicado um museu conhecido e dentro desse museu cada aluno pode conhecer um pouco mais de história, além de fazer um tour para conhecer mais o lugar em que estão visitando online.</li>
        </ul>
    </div>
